...
static CollisionBehavior collision_behaviors[ENTITY_TYPE_COUNT][ENTITY_TYPE_COUNT] = {
  //            WORLD                       ITEM                        PLAYER
  /* WORLD */ {COLLISION_BEHAVIOR_PHYSICS, COLLISION_BEHAVIOR_PHYSICS, COLLISION_BEHAVIOR_PHYSICS},
  /* ITEM */  {COLLISION_BEHAVIOR_PHYSICS, COLLISION_BEHAVIOR_PHYSICS, COLLISION_BEHAVIOR_TRIGGER},
